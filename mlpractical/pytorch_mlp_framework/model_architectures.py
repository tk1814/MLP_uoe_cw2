...
# class ConvolutionalProcessingBlockBN_RC(nn.Module):
#     def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
#         super(ConvolutionalProcessingBlockBN_RC, self).__init__()
...
# class ConvolutionalDimensionalityReductionBlockBN_RC(nn.Module):
#     def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
#         super(ConvolutionalDimensionalityReductionBlockBN_RC, self).__init__()
...
#         out = self.layer_dict['conv_1'].forward(out)
#         out = batchNorm(out)
#         xx = F.avg_pool2d(out, self.reduction_factor)
